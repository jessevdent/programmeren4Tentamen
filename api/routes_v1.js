...
routes.get('/films', function(req, res){
    ...
    var query = 'SELECT * from film, inventory where exists (select distinct film_id from inventory where inventory.film_id = film.film_id) ORDER BY `film`.`film_id` ASC';
